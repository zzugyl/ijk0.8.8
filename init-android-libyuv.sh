...
IJK_LIBYUV_UPSTREAM=https://github.com/zzugyl/libyuv.git
IJK_LIBYUV_FORK=https://github.com/zzugyl/libyuv.git
IJK_LIBYUV_COMMIT=2e9f3e5cf5f3c71a4a34893ceb20c5d69689390f
